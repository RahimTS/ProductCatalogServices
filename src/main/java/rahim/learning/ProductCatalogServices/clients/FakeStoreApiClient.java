package rahim.learning.ProductCatalogServices.clients;
...
public class FakeStoreApiClient {
    ...
    public FakeStoreProductDto getProductById(Long productId) {
        ResponseEntity<FakeStoreProductDto> fakeStoreProductDtoResponseEntity = requestForEntity(
                "http://fakestoreapi.com/products/{productId}", HttpMethod.GET, null,
    ...
    private FakeStoreProductDto validateFakeStoreResponse(
